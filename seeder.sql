...
INSERT INTO users (birthdate, email, first_name, last_name, password, title, username, family_id, img_path) VALUES
  ...
  ('2007-02-27', 'adrian@gmail.com', 'Adrian', 'Paree', '$2a$10$9HfpQWmiTmAsGSNg5vFP0e5MZ81Zs5FWMRG54NQBwXCe4WRVXBHVS', null, 'Adrian', 1, null),
  ('1970-09-25', 'maribel@gmail.com', 'Maribel', 'Paree', '$2a$10$9HfpQWmiTmAsGSNg5vFP0e5MZ81Zs5FWMRG54NQBwXCe4WRVXBHVS', 'Mom', 'Maribel', 1, null),
  ('1995-10-27', 'Jonathan@gmail.com', 'Jonathan', 'Moncivais', '$2a$10$9HfpQWmiTmAsGSNg5vFP0e5MZ81Zs5FWMRG54NQBwXCe4WRVXBHVS', 'Jona', 'Jonathan', 1, null),
  ('1996-07-14', 'Karen@gmail.com', 'Karen', 'Mendez', '$2a$10$9HfpQWmiTmAsGSNg5vFP0e5MZ81Zs5FWMRG54NQBwXCe4WRVXBHVS', null, 'Karen', 1, null),
...
INSERT INTO events_categories (event_id, category_id) VALUES (1, 1), (1, 9), (2, 1), (2, 2), (3, 8), (3, 9), (4, 8), (4, 9), (5, 1), (5, 9), (5, 10), (6, 10), (7, 11), (8, 9), (8, 10);

# INSERT INTO event_comments (created_on, event_id, user_id, comment_body)
#   VALUES ();
